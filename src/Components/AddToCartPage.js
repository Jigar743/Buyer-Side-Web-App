...
import useProductQuantity from "../customHooks/useProductQuantity";
import useProductDelete from "../customHooks/useProductDelete";
...
export default function AddToCartPage() {
  ...
  const [handlePlus, handleMinus] = useProductQuantity();
  const [handleDeleteProduct] = useProductDelete()
